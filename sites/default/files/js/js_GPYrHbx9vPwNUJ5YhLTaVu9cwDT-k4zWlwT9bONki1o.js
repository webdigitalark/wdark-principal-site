...
function drawParticle(x, y, x2, y2, life, ttl, radius, hue) {
  ...
  ctx.a.strokeStyle = `hsla(197,69%,62%,${fadeInOut(life, ttl)})`;
  ctx.a.beginPath();
  ctx.a.moveTo(x, y);
  ctx.a.lineTo(x2, y2);
  ctx.a.stroke()
